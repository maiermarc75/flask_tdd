...
def test_create_article():
    ...
    THEN a new Article must exist in the database with the sam attributes
    """
    cmd = CreateArticleCommand(
        author="maiermarc75@gmail.com",
        title="New Article",
    ...
    assert db_article.author == article.title
...
def test_create_article_already_exists():
    ...
    Article(
        author="maiermarc75@gmail.com",
        title="New Article",
        content="Super extra awesomearticle",
    ).save()
